...
const CANDIDATES = [
  { id:1, first:'María', last:'Restrepo', loc:'Bogotá, Colombia', verified:true,
    ...
    skills:['Customer Service','Bilingual English','Zendesk'], email:'maria.restrepo@gmail.com',
  ...
  { id:2, first:'Juan', last:'Pérez', loc:'Medellín, Colombia', verified:false,
    ...
    skills:['Call Center','CRM','Customer Support'], email:'juanperez88@outlook.com',
  ...
  { id:3, first:'Andrea', last:'Gómez', loc:'Ciudad de México, México', verified:true,
    ...
    skills:['CX','SaaS','Bilingual English'], email:null,
  ...
  { id:4, first:'Carlos', last:'Villanueva', loc:'Manila, Filipinas', verified:true,
    ...
    skills:['E-commerce','Customer Service','Shopify'], email:'carlos.v@proton.me',
  ...
  { id:5, first:'Sofía', last:'Hernández', loc:'Buenos Aires, Argentina', verified:false,
    ...
    skills:['Fintech','Bilingual English','Support'], email:null,
  ...
  { id:6, first:'Daniel', last:'Mokoena', loc:'Johannesburg, Sudáfrica', verified:true,
    ...
    skills:['Telecom','Customer Care','English'], email:'d.mokoena@gmail.com',
  ...
  { id:7, first:'Valentina', last:'Cruz', loc:'Cali, Colombia', verified:false,
    ...
    skills:['Inbound','Bilingual English','Zendesk'], email:null,
  ...
  { id:8, first:'Miguel', last:'Santos', loc:'Cebú, Filipinas', verified:true,
    ...
    skills:['Technical Support','SaaS','Troubleshooting'], email:'miguel.santos@gmail.com',
  ...
  { id:9, first:'Laura', last:'Jiménez', loc:'Guadalajara, México', verified:false,
    ...
    skills:['Logistics','Customer Service','Bilingual English'], email:null,
...
function runSearch() {
  ...
  document.querySelector('[data-note]').textContent = 'Buscando, re-validando open-to-work y enriqueciendo email vía Apollo…';
  tbody.innerHTML = '';
  updateCount(0);
  ...
  CANDIDATES.forEach((c, idx) => {
    setTimeout(() => {
      ...
      tr.innerHTML = `
        ...
        <td class="cand-email"><span class="email-cell email-loading"><span class="spinner"></span> enriqueciendo…</span></td>
      ...
      updateCount(tbody.children.length);
      setTimeout(() => {
        const cell = tr.querySelector('.cand-email');
        cell.innerHTML = EMAIL_RESOLUTION[c.id]
          ? `<span class="email-cell">${c.email}</span>`
          : `<span class="email-cell email-none">sin email</span>`;
        resolved++;
        if (resolved === CANDIDATES.length) { note.style.display = 'none'; if (ind) ind.style.display = 'none'; }
      }, 700 + Math.random() * 900);
    }, 300 + idx * 240);
  });
